...
module.exports.loop = function () {
    ...
    require('plan_center').update();
    require('plan_mineral').update();
    require('plan_upgrade').update();
    require('plan_build').update();
    require('plan_distribute').update();
    powerSpawnExp.run();
    //require('plan_source').update();
    ...
    for (var i=0; i<roles.length;i++) {
        var role = roles[i];
        roleContainer.push(require('role_'+role));
    }
