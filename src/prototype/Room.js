    ...
    load: function(){
        ...
        Room.prototype.decompose = function(product,amount,level){
            const noDecom = [RESOURCE_ENERGY,RESOURCE_POWER,RESOURCE_HYDROGEN,RESOURCE_OXYGEN,RESOURCE_UTRIUM,
                ...
                RESOURCE_UTRIUM_BAR,RESOURCE_OXIDANT,RESOURCE_REDUCTANT,RESOURCE_LEMERGIUM_BAR,RESOURCE_KEANIUM_BAR,RESOURCE_GHODIUM_MELT,RESOURCE_PURIFIER,RESOURCE_ALLOY,RESOURCE_CELL,RESOURCE_WIRE,RESOURCE_CONDENSATE];
